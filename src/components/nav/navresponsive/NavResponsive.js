...
function NavResponsive() {
  ...
  return (
    <nav className="nav-resp-container">
      ...
      <div
        className={
          clickSeach ? "nav-resp-bar-input" : "nav-resp-bar-input clicked"
        }
      >
      ...
      <div
        className={
          click ? "responsive-categories" : "responsive-categories clicked"
        }
      >
        <ul>
        ...
        <li onSelect={handleSelect}>
          <Link to={`/productos-filtrados/${lstCategoria[0]}`}>
            {lstCategoria[0]}
          </Link>
        </li>
        <li>
          <Link to={`/productos-filtrados/${lstCategoria[1]}`}>
            {lstCategoria[1]}
          </Link>
        </li>
        <li>
          <Link to={`/productos-filtrados/${lstCategoria[2]}`}>
            {lstCategoria[2]}
          </Link>
        </li>
        <li>
          <Link to={`/productos-filtrados/${lstCategoria[3]}`}>
            {lstCategoria[3]}
          </Link>
        </li>
        </ul>
