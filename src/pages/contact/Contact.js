...
const Contact = () => {
   ...
   const sendEmail = (e) => {
      ...
      emailjs.sendForm("service_jaeeuuf", "template_hxj8k1h", form.current).then(
         (result) => {
      ...
      <div>
         <div className="container container-contact">
            ...
            <div className="row row-contact">
               <div className="col-lg-6 col-sm-12 columna-izq-contact">
                  ...
                  <form ref={form} onSubmit={sendEmail} className="form-contact">
                     <div className="mb-3">
                        ...
                        <select
                           ...
                           <option value="Consulta sobre un pedido vía presencial">
                              Consulta sobre un pedido vía presencial
                           </option>
                     ...
                     <div className="mb-3">
                        ...
                        <input
                           type="email"
                           name="user_email"
                           className="form-control form-contact-control-correo"
                           id="correo-usuario"
                        />
                     </div>
               ...
               <div className="col-lg-6 col-sm-12 columna-derecha-contact pt-3">
                  <h1>Ubícanos en:</h1>
